...
public class Location {
    ...
    public Location() {
     ...
     public Location(String date_debut, String date_fin, int id_voiture, String matricule, String modele) {
    this.date_debut = date_debut;
    this.date_fin = date_fin;
    this.id_voiture = id_voiture;
    ...
    public Location(String date_debut, String date_fin, int prix_location, int id_voiture, String matricule, String modele) {
        this.date_debut = date_debut;
        this.date_fin = date_fin;
